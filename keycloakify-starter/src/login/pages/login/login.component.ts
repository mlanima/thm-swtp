...
import type { KcContext as KcContextGeneric } from '@keycloakify/angular/login/KcContext';
...
export class LoginComponent extends ComponentReference {
  kcContext = inject<Extract<KcContextGeneric, { pageId: 'login.ftl' }>>(KC_LOGIN_CONTEXT);
