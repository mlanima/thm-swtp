...
} from '../../services/professor-request.service';
...
@Component({
  selector: 'app-professor-request-page',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './professor-request-page.html',
})
export class ProfessorRequestPage implements OnInit {
