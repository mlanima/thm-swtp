...
import { handleSendPost, handleEditPost, handleDeletePost, handleSendInvite, handleSendEvent, } from '../streams/eventHandler.js';
...
export function startDiscordWorker() {
    const worker = new Worker('discord-actions', async (job) => {
        switch (job.name) {
            case 'sendPost':
